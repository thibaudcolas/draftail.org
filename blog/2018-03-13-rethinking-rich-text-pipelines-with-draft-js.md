...
![Diagram of the rich text lifecycle, from user input to page rendering](./assets/rethinking-rich-text-pipelines-with-draft-js/rich-text-lifecycle-v1.png)
...
![Screencast of Word copy-pasting into Wagtail’s previous editor. Some unwanted formatting makes its way into the saved content.](./assets/rethinking-rich-text-pipelines-with-draft-js/hallo-paste-from-word.gif)
...
![Screencast of Word copy-pasting into Wagtail’s new editor. Content is correctly filtered on paste.](./assets/rethinking-rich-text-pipelines-with-draft-js/draftail-paste-from-word.gif)

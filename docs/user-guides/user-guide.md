...
> Have a look at the [full list of keyboard shortcuts](/user-guides/keyboard-shortcuts.md).
...
Those shortcuts are extra convenient on touch screens, where it can be hard to move back and forth between text input and the toolbar. You can find the [full list of supported shortcuts](/user-guides/keyboard-shortcuts.md) next, but bear in mind that they won’t be active unless the editor has the corresponding formatting enabled.
...
Please have a look at the [full list of keyboard shortcuts](/user-guides/keyboard-shortcuts.md).
